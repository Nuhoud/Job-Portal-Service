import { Controller, Get, Post, Request, Body, Patch, Param, Delete, Query,HttpStatus, HttpCode } from '@nestjs/common';
...
export class JobOffersController {
  ...
  // Get job offers by employer (Employer/Admin only)
  ...
  // Get job offers expiring soon (Employer/Admin only)
  @Get('expiring-soon')
  @UseGuards(RolesGuard)
  @Roles(Role.EMPLOYER, Role.ADMIN)
  ...
  // Increment applications count (Internal use - typically called when someone applies)
  @Patch(':id/increment-applications')
  @HttpCode(HttpStatus.OK)
  async incrementApplicationsCount(@Param('id') id: string) {
    return this.jobOffersService.incrementApplicationsCount(id);
  }
